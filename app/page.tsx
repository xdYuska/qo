  ...
  return (
    <main>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 sm:py-20 text-center">
        <h1 className="text-3xl sm:text-5xl font-bold text-foreground font-display">
          Qediroglu MMC
        </h1>
        ...
        <Link
          href="/shop"
          className="mt-8 inline-block bg-foreground text-white text-sm font-medium px-6 py-3 rounded-lg hover:opacity-90 hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] active:translate-y-0 transition duration-200 ease-out"
        >
          Shop Now
        </Link>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-14 sm:pb-20">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
         <SmoothScrollLink 
            ...
            <h2 className="font-semibold text-foreground font-display">ABOUT US</h2>
          ...
          <SmoothScrollLink
            ...
            className="block p-6 border rounded-lg hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] active:translate-y-0 transition duration-200 ease-out"
          >
            <h2 className="font-semibold text-foreground font-display">DISTRIBUTION</h2>
            <p className="mt-2 text-sm text-black/60 dark:text-white/60">
          ...
          <SmoothScrollLink
            ...
            className="block p-6 border rounded-lg hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] active:translate-y-0 transition duration-200 ease-out"
          >
            <h2 className="font-semibold text-foreground font-display">IMPORTS</h2>
            <p className="mt-2 text-sm text-black/60 dark:text-white/60">
...
<section className="max-w-6xl mx-auto px-4 pb-14 sm:pb-20">
  <Link
    href="/locations"
    className="flex flex-col sm:flex-row items-center justify-between gap-4 p-8 rounded-lg bg-citrus text-white hover:opacity-90 hover:shadow-lg hover:-translate-y-1 active:scale-[0.98] active:translate-y-0 transition duration-200 ease-out"
  >
    ...
    <span className="shrink-0 text-sm font-medium bg-white text-citrus rounded-lg px-5 py-3">
      View Locations →
    </span>
  </Link>
</section>
